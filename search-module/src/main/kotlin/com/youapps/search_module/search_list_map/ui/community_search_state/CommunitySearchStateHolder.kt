...
sealed interface SearchByAreaState {
    ...
    data class Error(val domainErrorType: DomainErrorType = DomainErrorType.Undefined) :
        SearchByAreaState
...
data class CommunitySearchStateHolder(
    ...
    companion object {
        ...
        fun rememberCommunitySearchState(
            ...
            remember(searchQuery, currentRadiusValue, selectedFilterIndex, searchOperationState) {
                CommunitySearchStateHolder(
        ...
        fun bindViewModelState(
            ...
            currentRadiusValue = viewModel.currentRadiusValue.collectAsStateWithLifecycle(
                initialValue = 1f
            ),
            searchOperationState = viewModel.currentSearchByAreaState.collectAsStateWithLifecycle(
                initialValue = SearchByAreaState.Idle
            ),
