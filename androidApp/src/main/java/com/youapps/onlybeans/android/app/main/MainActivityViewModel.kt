...
class MainActivityViewModel(
    ...
    val biometricCapabilitiesState: StateFlow<SupportedDeviceAuthenticationMethods> =
        biometricCapabilitiesMutableState
    ...
    private val _navigationBarState: MutableStateFlow<MutableList<OBBottomNavigationBarItem>> =
        MutableStateFlow(
            mutableListOf(
